...
| Category | Text Color | Background rgba() |
|---|---|---|
| **Default (all others)** | `#FF545D` | `rgba(255, 84, 93, 0.11)` |
| **REG** | `#F78E25` | `rgba(247, 142, 37, 0.13)` |
| **KYC** | `#6DA884` | `rgba(109, 168, 132, 0.10)` |
| **BKO** | `#218FAA` | `rgba(33, 143, 170, 0.10)` |

> The alpha values come from the original 8-digit hex codes: `1C` = 28/255 ≈ 0.11, `21` = 33/255 ≈ 0.13, `1A` = 26/255 ≈ 0.10.
